...
class MainPageStellarBurgers(BasePage):
    ...
    def wait_main_page(self):
        self.wait_element_until_visible(MainLock.SIGN_IN_BUTTON)
    ...
    def click_lk_button(self):
        self.wait_element_until_visible(MainLock.USER_ACCOUNT_BUTTON)
    ...
    def wait_create_order_after_loading_page(self):
        self.wait_element_until_visible(MainLock.CONFIRM_ORDER_BUTTON)
    ...
    def close_popup_with_ingredient_details(self):
        self.wait_element_until_visible(MainLock.CLOSE_INGREDIENT)
    ...
    def wait_ingredient_bun_in_constructor(self):
        self.wait_element_until_visible(MainLock.DEFAULT_BUN_IN_BURGER)
    ...
    def check_open_popup_details_ingredient_bun(self):
        self.wait_element_until_visible(MainLock.INGREDIENT_POPUP_TITLE)
        return self.check_display_of_element(MainLock.INGREDIENT_POPUP_TITLE)
    ...
    def check_open_popup_with_order(self):
        self.wait_element_until_visible(MainLock.ORDER_IS_BEING_PREPARED)
        return self.check_display_of_element(MainLock.ORDER_IS_BEING_PREPARED)

    @allure.step('Проверить отображение элемента')
    def check_display_of_element(self, locator):
        return self.wait_element_until_visible(locator).is_displayed()
