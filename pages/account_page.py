...
class AccountPageStellarBurgers(BasePage):
    ...
    def click_list_order_button(self):
        self.wait_element_until_visible(UserLock.LIST_ORDER_BUTTON)
