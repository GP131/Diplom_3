import allure
from locators.password_recovery_page_locators import PasswordForgotPageLocators as PasswordLock
...
class PasswordForgotPageStellarBurgers(BasePage):
    ...
    def wait_password_forgot_page(self):
        self.wait_element_until_visible(PasswordLock.HEADER_PASSWORD_FORGOT_FORM)
    ...
    def check_password_field_active(self):
        return self.wait_element_until_visible(PasswordLock.PASSWORD_FIELD_ACTIVE)
