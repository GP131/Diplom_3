...
class ListOrdersPageStellarBurgers(BasePage):
    ...
    def wait_orders_page(self):
        self.wait_element_until_visible(ListOrdersLock.ORDERS_ALL_TIME)
    ...
    def click_one_order_in_list(self):
        self.wait_element_until_visible(ListOrdersLock.ONE_ORDER_IN_LIST)
    ...
    def get_count_orders(self, locator):
        self.wait_orders_page()
        self.wait_element_until_visible(locator)
    ...
    def get_id_order_in_progress(self):
        self.wait_element_until_visible(ListOrdersLock.ORDER_IN_PROGRESS)
    ...
    def check_open_popup_with_details_order(self):
        self.wait_element_until_visible(ListOrdersLock.ORDER_POPUP_DETAILS)
        return self.check_display_of_element(ListOrdersLock.ORDER_POPUP_DETAILS)
    ...
    def check_id_order_user_in_list_orders(self, id_order):
        ...
        self.wait_element_until_visible(order_locator)
        return self.check_display_of_element(order_locator)
